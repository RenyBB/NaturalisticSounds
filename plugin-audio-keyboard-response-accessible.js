var jsPsychAudioKeyboardResponseAccessible = (function (jspsych) {
  'use strict';
  ...
  class AudioKeyboardResponsePlugin {
      ...
      trial(display_element, trial, on_load) {
          ...
          const setupTrial = () => {
              ...
              const button = "<button id='play-sound' class='psButton' type='button' role='button'>Play sound</button>"

              // show prompt if there is one
              if (trial.prompt !== null) {
                  display_element.innerHTML = button + trial.prompt;
              } else {
          ...
          const end_trial = () => {
              document.getElementById('play-sound').onclick = null
